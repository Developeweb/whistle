...
<h1 align="center"> Whistle's Portfolio 🔥 </h1> 
<h3 align="center"> A clean, beautiful, responsive, and 100% customizable portfolio <br /> template for Whistle ! </h3>
...
<p align="center"> 
    <a href="https://github.com/Developeweb/whistle" target="_blank">
...
To view a live example, **[click here](https://github.com/Developeweb/whistle/)**
...
- After the successful installation of `nodejs` and `npm`, clone the repository into your local system using below command:
  ```bash
   git clone https://github.com/Developeweb/whistle.git
  ```
...
Note here that if you click [my portfolio](https://github.com/Developeweb/whistle), you can see animating the logo at the beginning. I have designed that logo in [`Figma`](https://www.figma.com/) and then animated it using css.
...
<table>
  <tbody>
    <tr>
      <td align="center" valign="top" width="14.28%"><a href=https://github.com/Developeweb/whistle"><img src="https://avatars3.githubusercontent.com/u/20843596?s=460&u=7f184b911f73ae1dc5765ab686fff2b2e984830f&v=4?s=100" width="100px;" alt="Ashutosh Hathidara"/><br /><sub><b>Ashutosh Hathidara</b></sub></a><br /><a href="https://github.com/ashutosh1919/masterPortfolio/commits?author=ashutosh1919" title="Code">💻</a> <a href="https://github.com/ashutosh1919/masterPortfolio/commits?author=ashutosh1919" title="Documentation">📖</a> <a href="#design-ashutosh1919" title="Design">🎨</a> <a href="#maintenance-ashutosh1919" title="Maintenance">🚧</a> <a href="#ideas-ashutosh1919" title="Ideas, Planning, & Feedback">🤔</a></td>
...
- Some Design and Implementation Ideas are taken from [Saad Pasta's Portfolio Project](https://github.com/Developeweb/whistle.git/whistle).
- The Logo of MasterPortfolio is inspired from [prettier-logo](https://github.com/prettier/prettier-logo) for [prettier](https://github.com/Developeweb/whistle.git) designed by @ianstormtaylor.
